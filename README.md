...
**시락마켓**은 **대규모 트래픽 환경**에서 **상품 구매 서비스**와 **실시간 조회수 랭킹**을 제공하는  
**이커머스 프로젝트**입니다.
...
![성능 개선 이미지](images/캐싱적용후%20성능.jpg)
...
<details>
<summary><b>*️ Redis 락 구현으로 동시성 이슈 제어 </b></summary>
